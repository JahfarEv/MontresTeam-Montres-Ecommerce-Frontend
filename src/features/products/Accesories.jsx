...
const AccessoriesPage = () => {
  ...
  const accessories = [
    ...
    },
    {
      ...
      category: "Cufflinks",
      image:
        "https://images.unsplash.com/photo-1602526216437-6df6ebadc177?w=400",
    },
    {
      id: 3,
  ...
  }, [accessories, selectedCategories, selectedPrices, searchTerm]);
      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-6">
          ...
          <p className="text-gray-600">
            Showing {filteredAccessories.length} Out Of {accessories.length} Products
          </p>
        </div>
      </header>
